           ...
           $(xml).find('entry').each(function(){
               ...
               if (title == story) {
                    ...
                    if (image_name.length > 0)
                       image_string = "<img src=\"" + image_name + "\" class=\"image_border image_feature\">";

                    if (video_link.length > 0)
                       video_string = "<br><center><video width=\"65%\" class=\"image_border image_feature\" controls><source src=\"" + video_link + "\" type=\"video/mp4\"></video></center>";
